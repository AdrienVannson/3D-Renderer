...
void renderSpheresCollision ()
{
    ...
    double l = 10;
    double d = 7;
    Parallelogram *floor = new Parallelogram(Vect(-l,-l), Vect(l,-l), Vect(-l,l),
                                             Material(Color(244,143,177), 0.07));
    scene->addObject(floor);

    // Walls
    Parallelogram *wall1 = new Parallelogram(Vect(-l,-d), Vect(-l,-d,5), Vect(l,-d),
                                             Material(Color(244,143,177), 0.07));
    scene->addObject(wall1);

    Parallelogram *wall2 = new Parallelogram(Vect(-d,-l), Vect(-d,l), Vect(-d,-l,5),
                                             Material(Color(244,143,177), 0.07));
    ...
    for (int x=-5; x<=5; x+=5) {
        for (int y=-5; y<=5; y+=5) {
            ...
            Sphere *sphere = new Sphere(Vect(x,y,4), 1, Material(Color(c1,c2,c3), 0.12));
